...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Página Web para Negocios en Mérida — INDEXA",
    description: "Crea tu página web profesional para tu negocio en Mérida. SEO local, WhatsApp y IA incluidos.",
    url: `${SITE_URL}/pagina-web-merida`,
...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    {
      "@type": "Question",
      name: "¿INDEXA ayuda a negocios en Mérida a aparecer en Google Maps?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Sí. Cada sitio web creado con INDEXA incluye Schema.org LocalBusiness con tus coordenadas y dirección en Mérida. Esto ayuda a Google Maps a mostrar tu negocio cuando alguien busca servicios en tu zona de Mérida.",
      },
    },
    {
      "@type": "Question",
      name: "¿Qué negocios en Mérida usan más INDEXA?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "En Mérida, INDEXA es muy popular entre restaurantes, hoteles boutique, servicios de plomería y electricidad, dentistas, estéticas, agencias de viajes y tiendas de artesanías. Cualquier PYME en Mérida puede crear su sitio web en minutos.",
      },
    },
  ],
};
...
const serviceJsonLd = buildCityServiceSchema({
  cityName: "Mérida",
  pagePath: "/pagina-web-merida",
});

export default function PaginaWebMerida() {
  const cityData = getCityData("merida");
  return (
    <>
      <Header />
      <main className="bg-white">
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          name: "Página Web para Negocios en Mérida — INDEXA",
          url: `${SITE_URL}/pagina-web-merida`,
          publisher: { "@type": "Organization", name: "INDEXA", url: SITE_URL, areaServed: { "@type": "City", name: "Mérida" } },
        }) }} />
        ...
        <section className="relative overflow-hidden bg-[#050816] pt-32 pb-24">
          ...
          <div className="relative mx-auto max-w-5xl px-4 text-center sm:px-6">
            <span className="inline-block rounded-full bg-indexa-orange/10 px-4 py-1.5 text-xs font-bold uppercase tracking-wider text-indexa-orange">Mérida, Yucatán</span>
            <h1 className="mt-4 text-4xl font-extrabold leading-[1.1] tracking-tight text-white sm:text-6xl">
              ...
              <span className="bg-gradient-to-r from-indexa-orange via-orange-400 to-amber-300 bg-clip-text text-transparent">negocio en Mérida</span>
            </h1>
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-white/60">
              INDEXA crea tu sitio web con IA en menos de 3 minutos. SEO local para Mérida y toda la Península de Yucatán, WhatsApp integrado y SSL incluido.
            </p>
        ...
        <section className="bg-gray-50 py-20">
          <div className="mx-auto max-w-3xl px-4 sm:px-6">
            <h2 className="mb-10 text-center text-3xl font-extrabold text-indexa-gray-dark">Preguntas frecuentes — Mérida</h2>
        ...
        <ServicesCrossLink contextLabel="Negocios en Mérida" placeName="Mérida" />


        <section className="bg-gradient-to-r from-indexa-orange to-orange-500 py-20">
          <div className="mx-auto max-w-3xl px-4 text-center sm:px-6">
            <h2 className="text-3xl font-extrabold text-white sm:text-4xl">¿Tienes un negocio en Mérida?</h2>
            <p className="mt-4 text-lg text-white/80">Atrae turistas y clientes locales con un sitio web profesional. Listo en menos de 3 minutos.</p>
