...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Página Web para Negocios en Guadalajara — INDEXA",
    description: "Crea tu página web profesional para tu negocio en Guadalajara. SEO local, WhatsApp y IA incluidos.",
    url: `${SITE_URL}/pagina-web-guadalajara`,
...
const jsonLd = {
  ...
  "@type": "WebPage",
  name: "Página Web para Negocios en Guadalajara — INDEXA",
  description: "Crea tu página web profesional para tu negocio en Guadalajara con IA.",
  url: `${SITE_URL}/pagina-web-guadalajara`,
  publisher: {
    "@type": "Organization",
    name: "INDEXA",
...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    {
      "@type": "Question",
      name: "¿Cómo aparece mi negocio de Guadalajara en Google?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Cada sitio de INDEXA incluye Schema.org LocalBusiness con tu ubicación en Guadalajara. Esto le dice a Google exactamente dónde estás y para qué búsquedas locales mostrarte. La mayoría de negocios empiezan a aparecer en 1-3 semanas.",
      },
    },
  ],
};
...
export default function PaginaWebGuadalajara() {
  const cityData = getCityData("guadalajara");
  return (
    <>
      <Header />
      <main className="bg-white">
        ...
        <section className="relative overflow-hidden bg-[#050816] pt-32 pb-24">
          ...
          <div className="relative mx-auto max-w-5xl px-4 text-center sm:px-6">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-white/60">
              INDEXA crea tu sitio web con IA en menos de 3 minutos. SEO local para Guadalajara y Jalisco,
              botón de WhatsApp y certificado SSL. Aparece en Google cuando tus clientes tapatíos te buscan.
            </p>
        ...
        <ServicesCrossLink contextLabel="Negocios en Guadalajara" placeName="Guadalajara" />

        <section className="bg-gradient-to-r from-indexa-orange to-orange-500 py-20">
          <div className="mx-auto max-w-3xl px-4 text-center sm:px-6">
            <h2 className="text-3xl font-extrabold text-white sm:text-4xl">
              ¿Tienes un negocio en Guadalajara?
            </h2>
            <p className="mt-4 text-lg text-white/80">
              Crea tu presencia digital profesional hoy. Rápido, fácil y sin necesitar programadores.
            </p>
            <Link
              href="/registro"
