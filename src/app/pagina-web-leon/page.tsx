...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Página Web para Negocios en León — INDEXA",
    description: "Crea tu página web profesional para tu negocio en León, Guanajuato. SEO local, WhatsApp y IA incluidos.",
    url: `${SITE_URL}/pagina-web-leon`,
...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    {
      "@type": "Question",
      name: "¿INDEXA sirve para negocios de calzado y manufactura en León?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Sí. León es la capital del calzado en México y INDEXA es ideal para talleres de calzado, distribuidores, boutiques y fábricas que quieren vender en línea o generar contactos por WhatsApp. El sitio se optimiza para búsquedas locales en León, Guanajuato.",
      },
    },
    {
      "@type": "Question",
      name: "¿INDEXA funciona para negocios en otras ciudades del Bajío como Guanajuato, Irapuato o Celaya?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Sí. INDEXA funciona para cualquier ciudad del Bajío: Guanajuato capital, Irapuato, Celaya, Silao, Salamanca y más. Cada sitio se configura con tu ciudad y municipio específico para el SEO local.",
      },
    },
  ],
};
    ...
    <>
      ...
      <main className="bg-white">
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          name: "Página Web para Negocios en León — INDEXA",
          url: `${SITE_URL}/pagina-web-leon`,
          publisher: { "@type": "Organization", name: "INDEXA", url: SITE_URL, areaServed: { "@type": "City", name: "León" } },
        }) }} />
        ...
        <section className="relative overflow-hidden bg-[#050816] pt-32 pb-24">
          ...
          <div className="relative mx-auto max-w-5xl px-4 text-center sm:px-6">
            <span className="inline-block rounded-full bg-indexa-orange/10 px-4 py-1.5 text-xs font-bold uppercase tracking-wider text-indexa-orange">León, Guanajuato</span>
            <h1 className="mt-4 text-4xl font-extrabold leading-[1.1] tracking-tight text-white sm:text-6xl">
              ...
              <span className="bg-gradient-to-r from-indexa-orange via-orange-400 to-amber-300 bg-clip-text text-transparent">negocio en León</span>
            </h1>
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-white/60">
              INDEXA crea tu sitio web con IA en menos de 3 minutos. SEO local para León, el Bajío y todo Guanajuato. WhatsApp directo y SSL incluido para que tus clientes te encuentren en Google.
            </p>
        ...
        <section className="bg-gray-50 py-20">
          <div className="mx-auto max-w-3xl px-4 sm:px-6">
            <h2 className="mb-10 text-center text-3xl font-extrabold text-indexa-gray-dark">Preguntas frecuentes — León</h2>
        ...
        <section className="bg-gradient-to-r from-indexa-orange to-orange-500 py-20">
          <div className="mx-auto max-w-3xl px-4 text-center sm:px-6">
            <h2 className="text-3xl font-extrabold text-white sm:text-4xl">¿Tienes un negocio en León?</h2>
            <p className="mt-4 text-lg text-white/80">Destaca entre la competencia en el Bajío con un sitio web profesional e IA. Sin complicaciones.</p>
